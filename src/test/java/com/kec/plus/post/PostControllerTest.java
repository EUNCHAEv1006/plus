...
import com.kec.plus.test.ControllerTest;
...
public class PostControllerTest extends ControllerTest implements PostTest {
    @MockBean
    ...
    @Nested
    @DisplayName("게시판 조회 요청")
    class getPost {
        @DisplayName("게시판 조회 요청 성공")
        @Test
    ...
    class putPost {
        ...
        @DisplayName("게시글 수정 요청 실패 - 존재하지 않는 게시글ID")
        @Test
